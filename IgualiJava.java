package br.com.generatio.IgualiJava;
...
public class IgualiJava {
	...
	public static void main(String[] args) {
		...
		System.out.println("**                                        **");
		System.out.println("**    Dando um desconto para sua VIDA!    **");
		System.out.println("********************************************");
		System.out.println();
		...
		else if (pe1.getEtnia() == "(3)Indígena") {
			descontoEtnia = 10;
		} 
		...
		System.out.println(pe1.getNome() + ", qual sua Orientaçãoo Sexual?\n" + orientaS);
		int n = valor.nextInt();
